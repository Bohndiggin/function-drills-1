...
let nameGreeting = nameCheck("William")
...
function upperTime(str) {
  console.log(str.toUpperCase())
}

upperTime(sampleString)
...
function whaterverYouBelieveToBeAppropriate(money) {
  return Math.floor(money/3)
}

let totalFrogs = whaterverYouBelieveToBeAppropriate(68)
...
function whaterverYouBelieveToBeAppropriate2(money) {
  return Math.floor(money/3)
}

let totalFrogs2 = whaterverYouBelieveToBeAppropriate2(68)
...
let arrayIsAscending = reorder(sampleArray)
